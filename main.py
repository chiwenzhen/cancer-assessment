...
class App:
    def __init__(self, root):
        ...
        Tk.Label(frame_result, text=str(self.evaluator_svm.pipeline.score(x_test, y_test))).grid(row=0, column=1,
                                                                                             sticky=Tk.W)
